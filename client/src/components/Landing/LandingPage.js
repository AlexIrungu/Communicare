      ...
      <div className={styles["travel-agency-landing-page-ui"]}>
        <div className={styles["hero"]}>
          <div className={styles["decore"]}>
            ...
            />
            <img src={Decore} alt="Decore2038" className={styles["decore1"]} />
          </div>
          <div className={styles["dropdown"]}>
            <span className={styles["text"]}>{/* <span>EN</span> */}</span>
          </div>
        ...
        />
        <img src={dollar} alt="dollar112039" className={styles["dollar11"]} />
      </div>
